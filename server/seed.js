...
const users = [
    { name: 'Admin User', email: 'admin@eventseat.com', password: 'password123', role: 'admin' },
    { name: 'Demo User', email: 'user@eventseat.com', password: 'password123', role: 'user' },
    { name: 'Alice Smith', email: 'alice@eventseat.com', password: 'password123', role: 'user' },
    { name: 'Bob Johnson', email: 'bob@eventseat.com', password: 'password123', role: 'user' },
    { name: 'Charlie Dave', email: 'charlie@eventseat.com', password: 'password123', role: 'user' },
    { name: 'Diana Prince', email: 'diana@eventseat.com', password: 'password123', role: 'user' },
    { name: 'Ethan Hunt', email: 'ethan@eventseat.com', password: 'password123', role: 'user' },
    { name: 'Fiona Gallagher', email: 'fiona@eventseat.com', password: 'password123', role: 'user' },
    { name: 'George Miller', email: 'george@eventseat.com', password: 'password123', role: 'user' },
    { name: 'Hannah Montana', email: 'hannah@eventseat.com', password: 'password123', role: 'user' }
];
...
const seedDatabase = async () => {
    try {
        await mongoose.connect(process.env.MONGO_URI || 'mongodb://localhost:27017/eventseat');
        ...
        console.log('-------------------------------------------');
        console.log('Admin Email: admin@eventseat.com');
        console.log('User Email:  user@eventseat.com');
