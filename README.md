# EventSeat - Premium Event Booking & Seating Platform

EventSeat is a premium full-stack MERN (MongoDB, Express, React, Node.js) application that allows users to seamlessly browse, register, and pay natively for events. It features an administrative dashboard for event organizers to create and manage free and paid events. All bookings can be managed manually by an admin to handle payments directly.
